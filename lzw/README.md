...
* `pdfcpu` also hosts an improved version of Go's TIFF package at [github.com/iPaladinLLC/pdfcpu/tiff](https://github.com/iPaladinLLC/pdfcpu/tiff) leveraging the improved `compress/lzw`.
